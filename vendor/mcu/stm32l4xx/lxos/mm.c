...
extern int __bss_end__; /* _estack = 0x20000744 */
extern int _estack;     /* _estack = 0x2002FFFF */

int g_mm_region_num = 5;

mm_region_t g_mm_region[5];

void hw_mm_init(void)
{
//  g_mm_region[0].addr = (void *)&__bss_end__;
//  g_mm_region[0].size = (size_t)&_estack - (size_t)&__bss_end__;
